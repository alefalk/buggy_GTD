...
class GTDFeatureLayer100(nn.Sequential):
    def __init__(self,dropout_rate=0.,shallow=True):
        ...
        if shallow:
            self.add_module('linear', nn.Linear(3583, 1024)) 
        else:
...
class GTDFeatureLayer200(nn.Sequential):
    def __init__(self,dropout_rate=0.,shallow=True):
        ...
        self.shallow = shallow
        if shallow:
            self.add_module('linear', nn.Linear(6306, 1024)) 
        else:
            raise  NotImplementedError
...
class GTDFeatureLayer300(nn.Sequential):
    def __init__(self,dropout_rate=0.,shallow=True):
        ...
        self.shallow = shallow
        if shallow:
            self.add_module('linear', nn.Linear(8725, 1024)) 
        else:
            raise  NotImplementedError
...
class GTDFeatureLayer478(nn.Sequential):
    def __init__(self,dropout_rate=0.,shallow=True):
        ...
        self.shallow = shallow
        if shallow:
            self.add_module('linear', nn.Linear(12512, 1024)) 
        else:
            raise  NotImplementedError
